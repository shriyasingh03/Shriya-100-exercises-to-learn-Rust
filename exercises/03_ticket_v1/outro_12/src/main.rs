...
impl Order {
    pub fn new(product_name: String, quantity: u64, unit_price: u64) -> Order {
        Self::validate_product_name(&product_name);  // Add & here
        Self::validate_quantity(&quantity);          // Add & here
        Self::validate_unit_price(&unit_price);      // Add & here
    ...
    pub fn set_product_name(&mut self, product_name: String) {
        Self::validate_product_name(&product_name);  // Add & here (already correct)
        self.product_name = product_name;
    }

    pub fn set_quantity(&mut self, quantity: u64) {
        Self::validate_quantity(&quantity);  // Add & here (already correct)
        self.quantity = quantity;
    }

    pub fn set_unit_price(&mut self, unit_price: u64) {
        Self::validate_unit_price(&unit_price);  // Add & here (already correct)
